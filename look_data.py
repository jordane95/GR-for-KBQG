...
def main():
    ...
    parser.add_argument("--predict_file", default="data/wq/reina_validation")
    ...
    parser.add_argument("--model_path", type=str, default="pretrain_model/jointgt_bart")
    parser.add_argument("--tokenizer_path", type=str, default="pretrain_model/jointgt_bart")
